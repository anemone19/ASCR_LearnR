...
One frogs is in our first distance bin (0 to 10 meters), five in the second, twelve in the third and so forth. As is, it's not an extremely interesting graph, but if we add the amount of frogs we detected within each distance bin (Click 'Add detections'), it starts to become a bit more informative.

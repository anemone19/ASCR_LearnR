...
Below the detection history data, you'll also see the actual number of frogs ($N$), an estimate of the overall probability of detection ($p^*$) and an estim ate of abundance that was calculated as follows:

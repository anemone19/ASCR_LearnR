...
We extract the confidence intervals using the function $\texttt{confint()}$ and specify the argument **type** as "fitted" to ensure our confidence intervals are on the same scale as our estimates. 
...
3. Obtain appropriate variance estimates using the bootstrap procedure using N = 10 and save the output as "model2_boot".
